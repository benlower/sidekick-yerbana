...
const systemMessage = _jsx(SidekickYerbanaSystemMessage, {});
const tools = {
...
export default function SidekickYerbana() {
    return (_jsx(Sidekick, { role: "customer service agent for Yerbana tea company", systemMessage: systemMessage, tools: tools, finalSystemMessageBeforeResponse: finalSystemMessageBeforeResponse }));
}
